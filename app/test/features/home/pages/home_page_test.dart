...
void main() {
  group('HomePage', () {
    testWidgets('shouldDisplayMessageMetadata', (WidgetTester tester) async {
      // Arrange
      ...
      // Wait for the widget to load the message
      await tester.pumpAndSettle();

      // Assert - Check that message metadata is displayed
      expect(find.text('John Doe'), findsOneWidget); // Sender name
      expect(find.textContaining('1:05'), findsOneWidget); // Duration (1 minute 5 seconds)
      expect(find.textContaining('Jan 1'), findsOneWidget); // Timestamp
    });
  });
}